...
?>
      ...
      <footer class="footer">
        ...
        <div class='alert alert-success hidden-md hidden-lg hidden-print'><div class='text-right'>Laboratory Information Management System | &copy; 2021. All Right Reserved.</div></div>
      </footer>
    </div>
