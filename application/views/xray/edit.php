      ...
      <fieldset>
        ...
        <div>
          ...
          <div class="form-group">
            ...
            <div class="col-md-6"><input type="text" name='xray_name_fa' id='xray_name_fa' value="<?php echo set_value('xray_name_fa', $xray->xray_name_fa);?>" class='form-control' placeholder='Sample Xray Name' title='Sample Xray Name'  required /></div>
          </div>
          <div class="form-group">
